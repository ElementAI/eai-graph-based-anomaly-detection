...
from eai_graph_tools.airflow_data.dag_components.canonical import get_setup_experiment, \
    get_fit_predict_random_forest_classifier, \
    load_config_file, \
    get_create_interval_metrics_tabular_random_forest_classifier
...
def create_tabular_prediction_dag(dag,
    ...
    local_outlier_factor_fit_predict = get_fit_predict_random_forest_classifier(dag,
                                                                                cfg_name,
                                                                                force_exec=True)
    create_interval_metrics = get_create_interval_metrics_tabular_random_forest_classifier(dag,
                                                                                           cfg_name,
                                                                                           force_exec=True)
